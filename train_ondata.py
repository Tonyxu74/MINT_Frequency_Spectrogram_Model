...
def train():
    ...
    iterator_train = GenerateIterator('./data/preproc_online_train/', eval=False, spectro_in=True)
    iterator_val = GenerateIterator('./data/preproc_online_val/', eval=True, spectro_in=True)
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        iterator_train.dataset.std = 0.7
